...
var DashboardButton = FindDotaHudElement("DashboardButton");
...
function ExitButton(data) {
    FindDotaHudElement("DashboardButton").visible = true;
}

GameEvents.Subscribe("ExitButton", ExitButton);