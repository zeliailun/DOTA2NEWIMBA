...
function imba_beastmaster_inner_beast:OnSpellStart()
	...
	self.pfx = ParticleManager:CreateParticle("particles/econ/items/beastmaster/bm_shoulder_ti7/bm_shoulder_ti7_roar_2.vpcf", PATTACH_CUSTOMORIGIN, self:GetCaster())
